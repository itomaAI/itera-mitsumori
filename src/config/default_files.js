    ...
    <main class="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-y-auto pb-10">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6">
            ...
            <section class="bg-panel rounded-2xl p-8 border border-border-main shadow-lg relative overflow-hidden group">
                ...
                <h2 class="text-xl font-bold mb-2">見積もりサポートアシスタント</h2>
                <p class="text-sm text-text-muted mb-8 leading-relaxed max-w-lg">
                    OCR解析結果の確認や見積書の比較、自社フォーマットへの転記などの作業をAIがサポートします。<br>
        ...
        <div class="flex flex-col gap-6">
            ...
            <section class="bg-card rounded-2xl p-5 border border-border-main border-dashed">
                ...
                <div class="flex flex-col gap-2">
                    <button onclick="if(window.MetaOS) MetaOS.ai.ask('見積書を自社フォーマットに変換してください')" class="text-left text-xs bg-panel hover:bg-hover px-3 py-2.5 rounded-lg border border-border-main transition text-text-main shadow-sm truncate">
                        "見積書を自社フォーマットに変換して"
                    </button>
                    <button onclick="if(window.MetaOS) MetaOS.ai.ask('A社とB社の見積を比較して違いを教えてください')" class="text-left text-xs bg-panel hover:bg-hover px-3 py-2.5 rounded-lg border border-border-main transition text-text-main shadow-sm truncate">
                        "見積を比較して"
                    </button>
